            ...
            <CardContent>
              <div className="space-y-3">
                <div className="flex items-center">
                  ...
                  <Link href="#" className="text-sm hover:underline">Q1 Financial Report 2023</Link>
                </div>
                <div className="flex items-center">
                  <FileText className="h-4 w-4 mr-2 text-muted-foreground" />
                  <Link href="#" className="text-sm hover:underline">Annual Budget 2023</Link>
                </div>
                <div className="flex items-center">
                  <FileText className="h-4 w-4 mr-2 text-muted-foreground" />
                  <Link href="#" className="text-sm hover:underline">Financial Projections 2023-2024</Link>
                </div>
              </div>
            </CardContent>
          </Card>
